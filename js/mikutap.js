var load_json="data/main/main.json";
...
var MainManager = function() {
    ...
    function n(n) { (U = !U) ? ($("#bt_feedback a").text("反馈: 开启"), aidn.util.setCookie("fb", "on", 2592e3)) : ($("#bt_feedback a").text("反馈: 关闭"), aidn.util.setCookie("fb", "off", 2592e3)),
        n && n.preventDefault()
    }
    function o(n) { (T = !T) ? ($("#bt_backtrack a").text("背景音乐: 开启"), aidn.util.setCookie("bt", "on", 2592e3)) : ($("#bt_backtrack a").text("背景音乐: 关闭"), aidn.util.setCookie("bt", "off", 2592e3)),
        n && n.preventDefault()
    }
    function r() {
        C.update(),
    ...
    this.init = function() { !
        function() {
            ...
            var n = 1;
            2 <= window.devicePixelRatio && (n = 2); (I = PIXI.autoDetectRenderer(G, A, {
    ...
    function() {
        ...
        this.init = function(n, a) {
            ...
            function(n) {
                c = n;
                for (var a = [], e = 0; e < o; e++) a[e] = [e + ".mp3"]; (r = new WebAudioManager).load("data/track/track.json", a, t, i)
            } (n)
        },
    ...
    function() {
        ...
        this.init = function(n, a) {
            ...
            function(n) {
                c = n;
                for (var a = [], e = 0; e < s; e++) a[e] = [e + ".mp3"]; (o = new WebAudioManager).load(load_json, a, t, i)
            } (n)
        };
    ...
    function() {
        ...
        n = function(n) {
            ...
            this.flash = function() {
                ...
                for (var n = 0; n < 3; n += 2) gsap.delayedCall(.07 * n, a),
        ...
        function l(n, a) {
            ...
            t = 0; t < e; t++) {
                var i = M[t];
                if (i.hitcheck(n, a)) return u != i.id && i.play(),
                i.id
            }
            return ! 1
        }
        ...
        function i(n) {
            ...
            e = l(a.x, a.y);
            if (c(e), n.originalEvent && n.originalEvent.touches) for (var t = n.originalEvent.touches.length,
            i = 1; i < t; i++) {
        ...
        this.init = function() {
            ...
            z.addChild(f),
            (T = new n(b)).setColor(0x66ccff, 0)
        },
        this.start = function() {
            E || ($("#view").on("mousedown", i), $(window).on("mousemove", o), $(window).on("mouseup", h), $(window).on("keydown", a), $(window).on("keyup", e)),
            (E || window.TouchEvent) && ($("#view").on("touchstart", i), $(window).on("touchmove", o), $(window).on("touchend", h)),
            $("#view").css("cursor", "pointer")
        },
        this.end = function() {
            E || ($("#view").off("mousedown", i), $(window).off("mousemove", o), $(window).off("mouseup", h), $(window).off("keydown", a), $(window).off("keyup", e)),
            (E || window.TouchEvent) && ($("#view").off("touchstart", i), $(window).off("touchmove", o), $(window).off("touchend", h)),
        ...
        function(n, a) {
            ...
            this.play = function() { !
                function() {
                    ...
                    for (var n = 10,
                    a = L(), e = Math.min(G, A) / 64 * (.6 * Math.random() + .7), t = 2, i = 0; i < 40; i++) {
        ...
        function(n, a) {
            ...
            this.play = function() { !
                function() {
                    u.clear(),
                    u.visible = !0,
                    Math.random() < .5 ? (u.x = 0, u.y = 0, u.rotation = 0) : (u.x = G, u.y = A, u.rotation = Math.PI),
                    c = l = 0,
